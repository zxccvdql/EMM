...
class MTLTrainer(object):
    ...
    def fit(self, train_dataloader, val_dataloader, mode = 'base', seed = 0, file_path = '/openbayes/home/torch-rechub/examples/ranking/Ali-CPP/result-mmoe-10.txt'):
        total_log = []
        e_scores = 0
        ...
        self.model.load_state_dict(torch.load(os.path.join(self.model_path, "model_{}_{}.pth".format(mode, seed))))
